      ...
      <div className="OneMember--content">
        ...
        <div className="OneMember--secondField">
          <div className="OneMember--secondField--description">
            ...
            tempora architecto accusantium velit minus sit ullam tenetur veniam
            id rem facilis voluptas atque, voluptate aspernatur amet
            dignissimos! Laudantium earum possimus ipsam accusamus quos error
            provident, nisi animi maiores dolore veniam libero enim corrupti
            labore consectetur nihil hic laboriosam expedita in quam tempora
            odit. Laboriosam, unde expedita.
          </div>
